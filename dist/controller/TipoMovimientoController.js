...
class TipoMovimientoController {
    constructor() {
        this.TipoRepository = typeorm_1.getRepository(TipoMovimiento_1.TipoMovimiento);
    }
    all(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.TipoRepository.find(reglas);
        });
    }
    one(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.TipoRepository.findOne(request.params.id);
        });
    }
    save(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.TipoRepository.save(request.body);
        });
    }
    ...
    update(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.TipoRepository.update(request.params.id, request.body);
        });
    }
}
exports.TipoMovimientoController = TipoMovimientoController;
//# sourceMappingURL=TipoMovimientoController.js.map