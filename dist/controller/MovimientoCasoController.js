...
class MovimientoCasoController {
    constructor() {
        this.MovimientoRepository = typeorm_1.getRepository(MovimientoCaso_1.MovimientoCaso);
    }
    ...
    one(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.MovimientoRepository.findOne(request.params.id);
        });
    }
    save(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.MovimientoRepository.save(request.body);
        });
    }
    ...
    update(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.MovimientoRepository.update(request.params.id, request.body);
        });
    }
}
exports.MovimientoCasoController = MovimientoCasoController;
//# sourceMappingURL=MovimientoCasoController.js.map