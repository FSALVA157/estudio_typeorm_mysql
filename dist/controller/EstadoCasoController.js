...
class EstadoCasoController {
    constructor() {
        this.EstadoRepository = typeorm_1.getRepository(EstadoCaso_1.EstadoCaso);
    }
    all(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.EstadoRepository.find(reglas);
        });
    }
    one(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.EstadoRepository.findOne(request.params.id);
        });
    }
    save(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.EstadoRepository.save(request.body);
        });
    }
    ...
    update(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.EstadoRepository.update(request.params.id, request.body);
        });
    }
}
exports.EstadoCasoController = EstadoCasoController;
//# sourceMappingURL=EstadoCasoController.js.map