...
class ObjetoController {
    constructor() {
        this.ObjetoRepository = typeorm_1.getRepository(Objeto_1.Objeto);
    }
    all(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.ObjetoRepository.find(reglas);
        });
    }
    one(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.ObjetoRepository.findOne(request.params.id);
        });
    }
    save(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.ObjetoRepository.save(request.body);
        });
    }
    ...
    update(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.ObjetoRepository.update(request.params.id, request.body);
        });
    }
}
exports.ObjetoController = ObjetoController;
//# sourceMappingURL=ObjetoController.js.map