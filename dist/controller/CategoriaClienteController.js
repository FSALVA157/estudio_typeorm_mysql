...
class CategoriaClienteController {
    constructor() {
        this.CatCliRepository = typeorm_1.getRepository(CategoriaCliente_1.CategoriaCliente);
    }
    all(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (request.query.fields) {
                ...
                if (!fields.includes('id_categoria_cli')) {
                    fields.push('id_categoria_cli');
                }
            }
            ;
            ...
            return yield this.CatCliRepository.find(reglas);
        });
    }
    one(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.CatCliRepository.findOne(request.params.id);
        });
    }
    save(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.CatCliRepository.save(request.body);
        });
    }
    ...
    update(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.CatCliRepository.update(request.params.id, request.body);
        });
    }
}
exports.CategoriaClienteController = CategoriaClienteController;
//# sourceMappingURL=CategoriaClienteController.js.map