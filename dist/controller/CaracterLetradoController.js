...
class CaracterLetradoController {
    constructor() {
        this.caracterRepository = typeorm_1.getRepository(CaracterLetrado_1.CaracterLetrado);
    }
    all(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.caracterRepository.find(reglas);
        });
    }
    one(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.caracterRepository.findOne(request.params.id);
        });
    }
    save(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.caracterRepository.save(request.body);
        });
    }
    ...
    update(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.caracterRepository.update(request.params.id, request.body);
        });
    }
}
exports.CaracterLetradoController = CaracterLetradoController;
//# sourceMappingURL=CaracterLetradoController.js.map