...
class FueroController {
    constructor() {
        this.FueroRepository = typeorm_1.getRepository(Fuero_1.Fuero);
    }
    all(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.FueroRepository.find(reglas);
        });
    }
    one(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.FueroRepository.findOne(request.params.id);
        });
    }
    save(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.FueroRepository.save(request.body);
        });
    }
    ...
    update(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.FueroRepository.update(request.params.id, request.body);
        });
    }
}
exports.FueroController = FueroController;
//# sourceMappingURL=FueroController.js.map