...
export class ObjetoExtraController {

    private ObjetoExtraRepository = getRepository(ObjetoExtrajudicial);
    ...
    async all(request: Request, response: Response, next: NextFunction) {
        ...
        if(fields != null){
           ...
           return await this.ObjetoExtraRepository.find(reglas);     
       
    }

    async one(request: Request, response: Response, next: NextFunction) {
        
        return await this.ObjetoExtraRepository.findOne(request.params.id);
    }

    async save(request: Request, response: Response, next: NextFunction) {
        return await this.ObjetoExtraRepository.save(request.body);
    }
    ...
    async update(request: Request, response: Response, next: NextFunction) {
        ...
        return await this.ObjetoExtraRepository.update(request.params.id,request.body);
    }
