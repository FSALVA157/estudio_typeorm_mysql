...
export class CategoriaClienteController {
    ...
    private CatCliRepository = getRepository(CategoriaCliente);
    ...
    async all(request: Request, response: Response, next: NextFunction) {
        ...
        if(fields != null){
           ...
           return await this.CatCliRepository.find(reglas);     
       
    }

    async one(request: Request, response: Response, next: NextFunction) {
        
        return await this.CatCliRepository.findOne(request.params.id);
    }

    async save(request: Request, response: Response, next: NextFunction) {
        return await this.CatCliRepository.save(request.body);
    }
    ...
    async update(request: Request, response: Response, next: NextFunction) {
        ...
        return await this.CatCliRepository.update(request.params.id,request.body);
    }
