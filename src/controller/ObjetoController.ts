...
export class ObjetoController {
    ...
    private ObjetoRepository = getRepository(Objeto);
    ...
    async all(request: Request, response: Response, next: NextFunction) {
        ...
        if(request.query.fields){
            ...
            if(!fields.includes('id_objeto')){
                fields.push('id_objeto')
            }
        ...
        if(fields != null){
           ...
           return await this.ObjetoRepository.find(reglas);     
       
    }

    async one(request: Request, response: Response, next: NextFunction) {
        
        return await this.ObjetoRepository.findOne(request.params.id);
    }

    async save(request: Request, response: Response, next: NextFunction) {
        return await this.ObjetoRepository.save(request.body);
    }

    async remove(request: Request, response: Response, next: NextFunction) {
        let objetoToRemove = await this.ObjetoRepository.findOne(request.params.id);
       return  await this.ObjetoRepository.remove(objetoToRemove);
    }

    async update(request: Request, response: Response, next: NextFunction) {
       
        return await this.ObjetoRepository.update(request.params.id,request.body);
    }
